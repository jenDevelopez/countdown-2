...
//       //  if (countdownDate) {
//         const targetDate = new Date("2025-01-03T11:30:00");
...
export default function App() {
  const [countdownDate] = useState(new Date("2025-02-03T11:30:00").getTime());
  const [timeLeft, setTimeLeft] = useState(null);
  ...
  return (
    ...
    >
      <div className="bg-transparent p-4 rounded-lg shadow-md">
        <div className="text-center mb-4">
          <h2 className="text-4xl font-bold text-yellow-400">Cuenta atrás</h2>
          <p className="text-gray-500">Para vernos</p>
        </div>
